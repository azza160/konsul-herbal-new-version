...
export default function EditEWalletPage() {
    const { eWallet, errors, user } = usePage().props;
    ...
    const handleSubmit = (e) => {
        ...
        router.put(route('ahli-ewallet-update', { id: eWallet.id }), formData, {
                        ...
                        >
                            <div>
                                ...
                                <p className="text-muted-foreground">
                                    Perbarui detail e-wallet Anda di bawah ini.
                                </p>
                            </div>
