...
export default function CreateArticlePage() {
    ...
    const handleChange = (e) => {
      ...
      const handleSubmit = (e) => {
        ...
        router.post("/admin/ahli/store", data, {
            onFinish: () => setIsLoading(false),
            onSuccess: () => {
                setFormData({ nama_spesialisasi: "", deskripsi_spesialisasi: "" });
                // Optional: redirect atau notifikasi berhasil
            },
            onError: () => {
